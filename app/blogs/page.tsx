...
import { Search, Calendar, Clock, ArrowRight, User, Sparkles, Tag, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="relative w-full min-h-screen text-foreground selection:bg-primary-blue selection:text-bg-yellow bg-custom-bg text-custom-fg">
      ...
      <main className="relative z-10 pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <motion.a
          href="/"
          className="inline-flex items-center gap-2 font-black text-xs uppercase tracking-wider text-primary-blue dark:text-accent-blue px-4 py-2 rounded-xl bg-white-custom/75 dark:bg-slate-800/80 shadow border border-primary-blue/10 mb-8"
          whileHover={{ x: -4 }}
          whileTap={{ scale: 0.95 }}
        >
          <ArrowLeft size={14} />
          <span>Back to Landing Command</span>
        </motion.a>
        ...
        {/* FEATURED BLOG BANNER (Only on Page 1 when not searching) */}
              ...
              <div className="flex items-center justify-between border-t border-primary-blue/10 pt-4 mt-4">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-primary-blue text-bg-yellow font-black text-xs flex items-center justify-center border border-primary-blue">
                    {featuredBlog.author ? featuredBlog.author.charAt(0) : "M"}
                  </div>
